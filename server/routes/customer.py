...
from models import Product_model, Customer_model
...
class Customer_resource(Resource):
    ...
    @set_attrs(method='get', route='all/', response_model=list[Customer_model] | list[None])
    ...
    @set_attrs(method='get', route='filtered/{product_id}', response_model=list[Customer_model])
